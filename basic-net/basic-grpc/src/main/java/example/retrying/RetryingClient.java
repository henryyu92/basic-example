...
public class RetryingClient {
    ...
    private static final Logger logger = Logger.getLogger(RetryingClient.class.getName());
            ...
            .fromJson(
                new JsonReader(
                    new InputStreamReader(
                        RetryingClient.class.getResourceAsStream(
                            "retrying_service_config.json"),
                        UTF_8)),
                Map.class);
    }

    public RetryingClient(String host, int port, boolean enableRetries){
    ...
    public static void main(String[] args) throws Exception {
        ...
        final RetryingClient client = new RetryingClient("localhost", 50051, enableRetries);
