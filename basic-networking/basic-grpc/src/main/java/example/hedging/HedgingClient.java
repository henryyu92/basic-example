...
public class HedgingClient {
    ...
    private static final Logger logger = Logger.getLogger(HedgingClient.class.getName());
    ...
    public HedgingClient(String host, int port, boolean hedging) {
            ...
            Map<String, ?> hedgingServiceConfig = new Gson().fromJson(
                new JsonReader(
                    new InputStreamReader(
                        HedgingClient.class.getResourceAsStream("hedging_service_config.json"), UTF_8)
                ), Map.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        final HedgingClient client = new HedgingClient("localhost", 50051, hedging);
